...
Public Class cls_ProdSer
    Private codigoprod As Integer
    Private codigoestoque As Integer
    Private nomeprodser As String
    Private precocustoprod As Double
    Private precovendaprod As Double
    Private marcaprod As String
    Private datacadastroprod As String
    ...
    Public Property acodigoprod()
        ...
        End Set
    End Property
    Public Property aprecocustoprod
        Get
            Return precocustoprod
        End Get
        Set(ByVal value)
            precocustoprod = value
        End Set
    End Property
    Public Property aprecovendaprod
        ...
        End Get
        Set(ByVal value)
            precovendaprod = value
        End Set
    End Property
    Public Property amarcaprod
        Get
            Return marcaprod
        End Get
        Set(ByVal value)
        ...
        End Set
    End Property
    Public Property adatacadastroprod
        Get
            Return dataCadastroprod
        End Get
        Set(ByVal value)
            dataCadastroprod = Convert.ToDateTime(value).ToString("MM/dd/yyyy")
        End Set
    End Property
    Public Property anomeprodser()
        Get
            Return nomeprodser
        End Get
        Set(ByVal value)
    ...
    Public Property acodigoestoque
        Get
    ...
    Public Function stringBanco(ByVal acodprodserest As Integer, ByVal CUD As String)
        If CUD = 1 Then
            Return "INSERT INTO Produto (nomeser_prod, precocus_prod, precoven_prod, ativo_prod, marca_prod, dtcad_prod, categ_prod, dtultest_prod, qtdeatualest_prod, qtdeminimoest_prod) VALUES ('" & anomeprodser & "','" & Replace(CDbl(aprecocustoprod), ",", ".") & "','" & Replace(CDbl(aprecovendaprod), ",", ".") & "','s','" & amarcaprod & "','" & datacadastroprod & "','pro','" & datacadastroprod & "'," & aqtdeatualestoque & "," & aqtdeminestoque & ")"
        ElseIf CUD = 2 Then
    ...
    Public Sub CUDProdSer(ByVal acodprodser As Integer, ByVal CUD As String)
        Using connection As SqlCeConnection = AbrindoConexaoBanco()
            Try
                Using Command As New SqlCeCommand(stringBanco(acodprodser, CUD), connection)
    ...
    Public Shared Function ReadProduto() As DataTable
        Using connection As SqlCeConnection = AbrindoConexaoBanco()
            Try
                ...
                Using Command As New SqlCeCommand("SELECT cod_prod, nomeser_prod, precocus_prod, precoven_prod, marca_prod, dtcad_prod, qtdeatualest_prod, qtdeminimoest_prod FROM Produto WHERE ativo_prod = 's' AND categ_prod = 'pro'", connection)
