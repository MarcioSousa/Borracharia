Public Class frm_Produto
    ...
    Private Sub carrega_grid()
        Try
            ...
            dgvProduto.DataSource = cls_ProdSer.ReadProduto
    ...
    Private Sub btnConfirma_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConfirma.Click
        ...
        Try
            If vpassou = True Then
                Dim vProduto As New cls_ProdSer
                If txtCodProd.Text = "" Then
                    vProduto.acodigoprod = 0
                Else
                    vProduto.acodigoprod = txtCodProd.Text
                End If
                vProduto.anomeprodser = txtNomeProd.Text
                vProduto.adatacadastroprod = dtpCadastro.Text
                vProduto.amarcaprod = txtMarcaProd.Text
                vProduto.aprecocustoprod = txtValorCusto.Text
    ...
    Private Sub frm_Produto_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        carrega_grid()
    End Sub
    ...
    Private Sub btnCasa_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCasa.Click
        Me.Close()
    End Sub
    ...
    Private Sub btnDuvida_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDuvida.Click
        MessageBox.Show("Esse formulário é para o preenchimento dos dados de seu Produto. Preencha corretamente. Você poderá fazer alterações nesses campos futuramente!!", "Ajuda", MessageBoxButtons.OK, MessageBoxIcon.Information)
    End Sub

    Private Sub txtMarcaProd_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtNomeProd.KeyPress, txtMarcaProd.KeyPress
        If e.KeyChar = "'" Then
            e.Handled = True
        End If
    End Sub

    Private Sub txtValorVenda_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtValorVenda.LostFocus, txtValorCusto.LostFocus
    ...
    Private Sub txtValorCusto_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtValorVenda.KeyPress, txtValorCusto.KeyPress
        If e.KeyChar = "'" Then
            e.Handled = True
            Exit Sub
        End If
